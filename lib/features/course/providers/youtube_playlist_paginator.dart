...
/// Handles YouTube playlist pagination logic
///
/// This class manages the state of pagination without inheriting from
/// ChangeNotifier, allowing the provider to control notifications.
class YoutubePlaylistPaginator {
  YoutubePlaylistPaginator({YoutubePlaylistDataSource? dataSource})
